...
def get_messages():
    global in_work
    print('-----------------------')
    api_key = 'xLy:CL7-nRtyt:dOc>src6cEJ7ntt0IucIe'
    response = get('https://sbz642-2a03-d000-a4-39e2-20fe-65d1-6d84-3872.ru.tuna.am//bots_api/all_chats', json={
        'api_key': api_key
    }).json()['messages']
    ...
    for message in response:
        if message['user_id'] == 1:
            if in_work:
                response_post = post('http://127.0.0.1:8080/bots_api/send_message', json={
